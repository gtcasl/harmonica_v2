...
# DVE full session
# Saved on Thu Apr 26 16:22:00 2018
# Designs open: 1
#   Sim: /nethome/pdas36/harmonica_v2.0/src/register_block/tb/simv
...
#<Session mode="Full" path="/nethome/pdas36/harmonica_v2.0/src/register_block/tb/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{75 142} {1834 1075}}
...
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1760
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 318
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1759} {height 317} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/nethome/pdas36/harmonica_v2.0/src/register_block/tb/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /nethome/pdas36/harmonica_v2.0/src/register_block/tb -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { tb.RBLOCK.clk tb.RBLOCK.rst_n tb.RBLOCK.read_en_0 tb.RBLOCK.read_en_1 tb.RBLOCK.write_en tb.RBLOCK.raddr_0 tb.RBLOCK.raddr_1 tb.RBLOCK.waddr tb.RBLOCK.wdata_0 tb.RBLOCK.rdata_0_0 tb.RBLOCK.rdata_0_1 }
...
catch {gui_list_select -id ${Hier.1} {tb.RBLOCK}}
...
gui_list_show_data -id ${Data.1} {tb.RBLOCK}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {tb.RBLOCK.read_en_0 tb.RBLOCK.read_en_1 tb.RBLOCK.write_en tb.RBLOCK.raddr_0 tb.RBLOCK.raddr_1 tb.RBLOCK.waddr tb.RBLOCK.wdata_0 }}
...
gui_open_source -id ${Source.1}  -replace -active tb /nethome/pdas36/harmonica_v2.0/src/register_block/tb/warp_8_write_read_test_all_lanes_16_32_32.sv
