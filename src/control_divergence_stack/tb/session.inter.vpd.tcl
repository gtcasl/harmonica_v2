...
# DVE full session
# Saved on Fri Mar 2 09:53:16 2018
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/nethome/pdas36/harmonica_v2.0/src/control_divergence_stack/tb/session.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{75 145} {1862 1106}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1787} {height 346} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{271 336} {1518 987}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 361} {child_wave_right 881} {child_wave_colname 178} {child_wave_colvalue 179} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { -ucligui} -dir ../tb -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active tb random_control_divergence_test.sv
...
gui_marker_create -id ${Wave.1} M1 1325
gui_marker_create -id ${Wave.1} M2 1395
gui_marker_select -id ${Wave.1} {  M1 }
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 1290 1569
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_add_group -id ${Wave.1} -after {New Group} {Group2}
gui_list_select -id ${Wave.1} {tb.CDS.fetch_PC }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group2  -item {tb.CDS.fetch_PC[31:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 1375
