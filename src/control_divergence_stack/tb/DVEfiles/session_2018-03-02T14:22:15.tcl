...
# DVE full session
# Saved on Fri Mar 2 14:21:50 2018
# Designs open: 1
...
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1789
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 346
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1786} {height 345} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { tb.CDS.STACK.clk tb.CDS.STACK.rst_n tb.CDS.STACK.data_in tb.CDS.STACK.push tb.CDS.STACK.pop tb.CDS.STACK.push_back tb.CDS.STACK.read_tos tb.CDS.STACK.data_vld tb.CDS.STACK.stack_full_next tb.CDS.STACK.top_stack_next tb.CDS.STACK.top_stack_prev tb.CDS.STACK.data_valid_next tb.CDS.pop tb.CDS.STACK.top_stack tb.CDS.STACK.data_out {tb.CDS.STACK.STACK[0]} {tb.CDS.STACK.STACK[1]} {tb.CDS.STACK.STACK[2]} {tb.CDS.STACK.STACK[3]} {tb.CDS.STACK.STACK[4]} {tb.CDS.STACK.STACK[5]} {tb.CDS.STACK.STACK[6]} {tb.CDS.STACK.STACK[7]} }

set _session_group_2 Group2
gui_sg_create "$_session_group_2"
set Group2 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb.CDS.STACK.stack_empty tb.CDS.STACK.stack_full tb.CDS.push tb.CDS.push_back tb.CDS.read_tos tb.CDS.save_in_data tb.CDS.fetch_PC tb.CDS.next_reconv_PC tb.CDS.data_in_1 tb.CDS.data_in_2 tb.CDS.new_reconv_PC tb.CDS.next_reconv_PC_data tb.CDS.popped_data_next tb.CDS.data_in_saved_next tb.CDS.clk tb.CDS.is_branch tb.CDS.popped_data tb.CDS.data_in_saved tb.CDS.curr_state tb.CDS.next_state }
...
gui_open_source -id ${Source.1}  -replace -active tb /nethome/pdas36/harmonica_v2.0/src/control_divergence_stack/tb/random_control_divergence_test.sv
