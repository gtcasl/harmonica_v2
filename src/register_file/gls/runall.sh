...
#./simv
vcs +incdir+$INCLUDE_DIR default_val_test_32_64.sv ../syn/netlist/register_file_32_64.v +define+NUMBER_OF_REGISTERS_IS_32+DATA_WIDTH_IS_64 +v2k -sverilog
./simv
...
#./simv
#vcs +incdir+$INCLUDE_DIR random_write_read_16_64.sv ../rtl/register_file.v +define+DATA_WIDTH_IS_64 +v2k -sverilog./simv
#./simv
