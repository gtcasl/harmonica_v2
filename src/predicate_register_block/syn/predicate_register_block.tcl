...
set submodule_1 register_bank
set submodule_2 register_block
set search_path [concat $search_path $include_dir ../rtl/ ../../$submodule/rtl/ ../../$submodule_2/rtl/]
...
set AREA	area
set TIMING      timing
set MODULE_NAME predicate_register_block
...
analyze -f verilog -d {DATA_WIDTH_IS_1} $submodule.v
analyze -f verilog -d {DATA_WIDTH_IS_1} $submodule_1.v
analyze -f verilog -d {DATA_WIDTH_IS_1} $submodule_2.v
analyze -f verilog -d {DATA_WIDTH_IS_1} $MODULE_NAME.v
